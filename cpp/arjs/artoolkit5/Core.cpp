...
namespace arjs::artoolkit5
{
    ...
    int32_t Core::loadCameraFromPath(const char* cparamPath)
    {
        ...
        {
            ARLOGe("loadCamera(): Error loading parameter file %s for camera.", cparamPath);
            return ERROR_INVALID_ARGUMENT;
        }
    ...
    int32_t Core::loadMarker(const char* patt_name, int* patt_id, ARHandle* arHandle, ARPattHandle** pattHandle_p)
    {
    ...
    int32_t Core::addMarker(const char* patt_name)
    {
        ...
        // Load marker(s).
        if (!loadMarker(patt_name, &(this->patt_id), this->arHandle, &(this->pattHandle)))
        {
    ...
    int32_t Core::ERROR_OK_()
    {
        return ERROR_OK;
    }
    int32_t Core::ERROR_NOT_INITIALIZED_()
    {
        return ERROR_NOT_INITIALIZED;
    }
    int32_t Core::ERROR_INVALID_ARGUMENT_()
    {
        return ERROR_INVALID_ARGUMENT;
    }
    ...
    int32_t Core::AR_DEBUG_DISABLE_()
    {
        return AR_DEBUG_DISABLE;
    }
    int32_t Core::AR_DEBUG_ENABLE_()
    {
        return AR_DEBUG_ENABLE;
    }
    ...
    int32_t Core::AR_IMAGE_PROC_FRAME_IMAGE_()
    {
        return AR_IMAGE_PROC_FRAME_IMAGE;
    }
    int32_t Core::AR_IMAGE_PROC_FIELD_IMAGE_()
    {
        return AR_IMAGE_PROC_FIELD_IMAGE;
    }
    ...
    int32_t Core::AR_MAX_LOOP_COUNT_()
    {
        return AR_MAX_LOOP_COUNT;
    }
    int32_t Core::AR_LOOP_BREAK_THRESH_()
    {
        return AR_LOOP_BREAK_THRESH;
    }

    int32_t Core::AR_LOG_LEVEL_DEBUG_()
    {
        return (int32_t)AR_LOG_LEVEL_DEBUG;
    }
    int32_t Core::AR_LOG_LEVEL_INFO_()
    {
        return (int32_t)AR_LOG_LEVEL_INFO;
    }
    int32_t Core::AR_LOG_LEVEL_WARN_()
    {
        return (int32_t)AR_LOG_LEVEL_WARN;
    }
    int32_t Core::AR_LOG_LEVEL_ERROR_()
    {
        return (int32_t)AR_LOG_LEVEL_ERROR;
    }
    ...
    int32_t Core::AR_MARKER_INFO_CUTOFF_PHASE_HEURISTIC_TROUBLESOME_MATRIX_CODES_()
    {
        return (int32_t)AR_MARKER_INFO_CUTOFF_PHASE_HEURISTIC_TROUBLESOME_MATRIX_CODES;
    }
