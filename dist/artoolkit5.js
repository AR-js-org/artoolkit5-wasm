...
async function createARToolKit5Module(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("artoolkit5.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("artoolkit5.wasm", import.meta.url).href;
}
...
export default createARToolKit5Module;
